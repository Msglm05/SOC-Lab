...
🔔 I had trouble with the Kali Linux machine with regard to the xfreerdp command, the which xfreerdp command returned 'no command found' although the freerdp3-x11 packages were present. The crowbar command was not able to sucessfully execute so I decided to pivot to a Ubuntu machine.
